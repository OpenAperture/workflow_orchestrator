defmodule CloudOS.WorkflowOrchestrator.Mixfile do
  ...
  defp deps do
    [
      {:poison, "~> 1.3.1"},
      {:cloudos_messaging, git: "https://#{System.get_env("GITHUB_OAUTH_TOKEN")}:x-oauth-basic@github.com/UmbrellaCorporation-SecretProjectLab/cloudos_messaging.git", ref: "8c521527a5cd67c729c204253311edc3dc01ecc1", override: true},
